...
export function KpiCard({ label, value, delta, icon: Icon, accent = "primary" }: Props) {
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl border border-border bg-card p-5 shadow-[var(--shadow-soft)] transition-all hover:-translate-y-0.5 hover:shadow-lg">
