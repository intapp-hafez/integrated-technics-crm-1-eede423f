...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      activity_status: "pending" | "in_progress" | "done" | "cancelled" | "delayed";
      activity_type: "Call" | "Meeting" | "Site Visit" | "Follow-up" | "Inspection" | "Email";
      ...
      notification_type:
        ...
        | "project"
        | "system";
      project_status: "On Track" | "At Risk" | "Delayed" | "Completed" | "On Hold";
      quotation_status:
        | "draft"
        | "pending_approval"
        | "sent"
