  ...
  return (
    <AppShell panel="manager" user={user} pageTitle={isAr ? "فرص فريقنا" : "Our Leads"}>
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2">
        <button onClick={() => setEditing("new")} className="shrink-0 inline-flex items-center gap-2 rounded-lg bg-primary px-3 py-2 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-brand)] active:scale-[0.98] hover:bg-primary/90">
