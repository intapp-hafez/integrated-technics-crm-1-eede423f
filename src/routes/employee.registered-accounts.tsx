...
export const Route = createFileRoute("/employee/registered-accounts")({
  component: EmployeeRegisteredAccountsPage,
});

function EmployeeRegisteredAccountsPage() {
  const { registeredAccounts, registeredAccountsPublic } = useStoreState();

  return (
    <AppShell panel="employee" user={{ name: "", role: "employee", initials: "" }} pageTitle="Registered Accounts">
      <div className="mb-6">
