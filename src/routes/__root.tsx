  ...
  head: () => ({
    meta: [
      ...
      { title: "INT-CRM — Integrated Technics" },
      {
        name: "description",
        content:
          "Enterprise CRM for Integrated Technics — leads, pipelines, projects, employees, attendance & analytics.",
      },
      ...
      { property: "og:title", content: "INT-CRM — Integrated Technics" },
      {
        ...
        content:
          "Enterprise CRM platform powering sales, operations and HR at Integrated Technics.",
      },
