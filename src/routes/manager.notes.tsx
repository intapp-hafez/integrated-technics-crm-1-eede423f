...
export const Route = createFileRoute("/manager/notes")({
  component: ManagerNotesPage,
});
...
function ManagerNotesPage() {
  ...
  return (
    <AppShell panel="manager" user={user} pageTitle={t("stickyNotes" as any) || "Sticky Notes"}>
