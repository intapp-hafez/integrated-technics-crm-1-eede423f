          ...
          return (
            <div
              ...
              onDrop={(e) => {
                ...
                if (lid) {
                  const lead = teamLeads.find((l) => l.id === lid);
              ...
              <div className="min-h-[80px] space-y-2">
                {stageLeads.map((l) => {
                  ...
                  <div
                    ...
                    className={`group cursor-pointer rounded-lg border bg-card p-3 shadow-sm transition ${!isWonOrLost ? "active:cursor-grabbing" : ""} ${
                      dragId === l.id
